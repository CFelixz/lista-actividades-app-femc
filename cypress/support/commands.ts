...
Cypress.Commands.add('validacionInicial', () => {
    ...
    cy.get(e2e.CAMPO_AGREGAR_ACTIVIDAD).should('be.visible').and('attr', 'value','');
    cy.get(e2e.BOTON_AGREGAR).should('be.visible').should('has.css', 'background-color', 'rgb(40, 167, 69)');
